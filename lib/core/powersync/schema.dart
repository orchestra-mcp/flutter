...
const powersyncSchema = Schema([
  ...
  // ── API Collections tables ──────────────────────────────────────
  Table('api_collections', [
    Column.integer('user_id'),
    Column.text('name'),
    Column.text('slug'),
    Column.text('description'),
    Column.text('base_url'),
    Column.text('auth_type'),
    Column.text('auth_config'),
    Column.text('variables'),
  ...
  Table('api_endpoints', [
    ...
    Column.text('path'),
    Column.text('headers'),
    Column.text('query_params'),
    Column.text('body'),
    Column.text('body_type'),
    Column.text('description'),
    Column.integer('sort_order'),
    Column.text('folder_path'),
    Column.text('created_at'),
    Column.text('updated_at'),
  ]),
  ...
  Table('presentation_slides', [
    Column.text('presentation_id'),
    Column.integer('user_id'),
    Column.integer('slide_number'),
    Column.text('layout'),
    Column.text('title'),
    Column.text('content'),
    Column.text('notes'),
