...
final _sendFormProvider = NotifierProvider<_SendFormNotifier, _SendFormState>(
  _SendFormNotifier.new,
);
...
final _showFormProvider = NotifierProvider<_ShowFormNotifier, bool>(
  _ShowFormNotifier.new,
);
...
final _searchProvider = NotifierProvider<_NotifSearchNotifier, String>(
  _NotifSearchNotifier.new,
);
          ...
          children: [
            ...
            notificationsAsync.when(
              ...
              data: (notifications) => Text(
                AppLocalizations.of(
                  context,
                ).nNotificationsSent(notifications.length),
                style: TextStyle(color: tokens.fgDim, fontSize: 13),
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: _inputDecoration(
                        tokens,
                        AppLocalizations.of(context).messagePlaceholder,
                      ),
                    ),
                    const SizedBox(height: 12),
                    // Target dropdown
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: [
                              DropdownMenuItem(
                                value: 'All Users',
                                child: Text(
                                  AppLocalizations.of(context).allUsersTarget,
                                ),
                              ),
                              DropdownMenuItem(
                                value: 'Admin',
                                child: Text(
                                  AppLocalizations.of(context).adminTarget,
                                ),
                              ),
                              DropdownMenuItem(
                                value: 'Team Owner',
                    ...
                    return Center(
                      child: Text(
                        searchQuery.isEmpty
                            ? AppLocalizations.of(
                                context,
                              ).noNotificationsSentYet
                            : AppLocalizations.of(
                                context,
                              ).noNotificationsMatch(searchQuery),
...
class _NotificationTile extends StatelessWidget {
  const _NotificationTile({required this.tokens, required this.notification});
  ...
  Widget build(BuildContext context) {
    ...
    final sentAt =
        notification['sent_at'] as String? ??
    ...
    final readPercent = totalCount > 0
