...
final _issuesProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((
  ref,
) async {
...
final _searchProvider = NotifierProvider<_IssueSearchNotifier, String>(
  _IssueSearchNotifier.new,
);
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      value: 'open',
                      child: Text(AppLocalizations.of(ctx).open),
                    ),
                    DropdownMenuItem(
                      value: 'in-review',
                      child: Text(AppLocalizations.of(ctx).inReview),
                    ),
                    DropdownMenuItem(
                      value: 'closed',
                      child: Text(AppLocalizations.of(ctx).closed),
                    ),
                  ],
                  onChanged: (v) {
                ...
                const SizedBox(height: 16),
                Text(
                  AppLocalizations.of(ctx).priority,
                  style: TextStyle(
                    color: tokens.fgMuted,
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                ...
                DropdownButton<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      value: 'low',
                      child: Text(AppLocalizations.of(ctx).low),
                    ),
                    DropdownMenuItem(
                      value: 'medium',
                      child: Text(AppLocalizations.of(ctx).medium),
                    ),
                    DropdownMenuItem(
                      value: 'high',
                      child: Text(AppLocalizations.of(ctx).high),
                    ),
                  ],
                  onChanged: (v) {
